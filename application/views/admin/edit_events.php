        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 style="float:left" class='text-primary'>Edit Events</h4>
                    <div class='text-right'>
                        <a href="<?php echo site_url().'/admin/manage_events'?>" class='btn btn-primary btn-sm'>
                            <i class='fa fa-arrow-circle-left mr-2'></i>Back To Events List
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <?php
                        echo form_open(site_url().'/admin/update_events',['enctype'=>'multipart/form-data']);
                   ...
                   <input type="hidden" name="old_image" value="<?php echo $value->image; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="summary" class='form-control' value="<?php echo $value->summary; ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" class='form-control' value="<?php echo $value->place; ?>" required>
                    </div>
