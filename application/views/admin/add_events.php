        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 style="float:left" class='text-primary'>Add Events</h4>
                    <div class='text-right'>
                        <a href="<?php echo site_url().'/admin/manage_events'?>" class='btn btn-primary btn-sm'>
                            <i class='fa fa-arrow-circle-left mr-2'></i>View Events
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <?php
                        echo form_open(site_url().'/admin/do_add_events',['enctype'=>'multipart/form-data']);
                    ?>
